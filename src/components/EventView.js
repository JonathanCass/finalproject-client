...
componentWillMount() {
  ...
  render() {
    console.log('event view this.props', this.props)
...
function mapStateToProps(appState) {
  return { dbUsers: appState.dbUsers, currentUserID : appState.currentUserId, parks: appState.parks , events : appState.events.event, activities : appState.activities}
}
