      ...
      <div style={styles.UserContainer}>
        ...
        <div style={styles.top}>
          ...
          <div style={styles.left}>
            ...
            <button style={styles.editInfo2} onClick={this.handleEdit} name="editAvatarUrl">Edit</button><div style={this.state.editAvatarUrl ?  styles.displayNone : styles.lineDisplay } >{this.props.dbUsers.users && this.props.dbUsers.users[this.props.match.params.userid].avatar}</div><input type="text" name="avatarUrl" placeholder="Avatar Url" onChange={this.handleChange} style={this.state.editAvatarUrl ? styles.lineInput : styles.displayNone} value={this.state.avatarUrl}></input>
            <button style={styles.editInfo2} onClick={this.handleEdit} name="editEmail">Edit</button><div style={this.state.editEmail ?  styles.displayNone : styles.lineDisplay } >{this.props.dbUsers.users && this.props.dbUsers.users[this.props.match.params.userid].email}</div><input type="text" name="avatarUrl" placeholder="Avatar Url" onChange={this.handleChange} style={this.state.editEmail ? styles.lineInput : styles.displayNone} value={this.state.email}></input>  
