      ...
      <div style={styles.UserContainer}>
        ...
        <div style={styles.top}>
          ...
          <div style={styles.left}>
            ...
            <button style={Number(this.props.match.params.userid) === Number(this.props.currentUserID) ? styles.editInfo2 : styles.displayNone } onClick={this.handleEdit} name="editEmail">Edit</button><div style={this.state.editEmail ?  styles.displayNone : styles.lineDisplay } >{this.props.dbUsers.users && this.props.dbUsers.users[this.props.match.params.userid].email}</div><input type="text" name="avatarUrl" placeholder="Avatar Url" onChange={this.handleChange} style={this.state.editEmail ? styles.lineInput : styles.displayNone} value={this.state.email}></input>  
           ...
           <div style={styles.right}>
            ...
            <div style={styles.infoBlock}>
              ...
              <div style={styles.buttonBar}><span>User's Hobbies</span><button name='editInterests' onClick={this.handleEdit} style={Number(this.props.match.params.userid) === Number(this.props.currentUserID) ? styles.editInfo : styles.displayNone }>Edit</button></div>
            </div>
